...
# --- Import multi-candle pattern functions directly ---
from .patterns.double_top import is_double_top
from .patterns.triple_top import is_triple_top
...
# --- Wrapper for new DoubleBottom class ---
def double_bottom(candles_df,
                   ohlc=__default_ohlc,
                   is_reversed=False,
                   target=None):
